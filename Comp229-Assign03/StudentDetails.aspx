<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentDetails.aspx.cs" Inherits="Comp229_Assign03.StudentDetails" %>
        ...
        <div class="col-md-offset-3 col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox runat="server" CssClass="form-control" ID="EnrollmentDateTextBox"
                    placeholder="Enrollment Date" TextMode="Date" required="true"></asp:TextBox>
            </div>
